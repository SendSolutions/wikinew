...
return [
    ...
    'recently_created_chapters' => 'Releases creados recientemente',
    ...
    'permissions_book_cascade' => 'Los permisos establecidos en los libros se aplicarán a los Releases contenidos y las páginas contenidas, a menos que tengan sus propios permisos definidos.',
    'permissions_chapter_cascade' => 'Los permisos establecidos en los Releases se aplicarán a las páginas contenidas, a menos que tengan sus propios permisos definidos.',
    ...
    'shelves_add_books' => 'Agregar libros en este Sistema',
    'shelves_drag_books' => 'Arrastre los libros aquí para añadirlos a este Sistema',
    'shelves_empty_contents' => 'Este Sistema no tiene libros asignados a él',
    ...
    'shelves_delete_explain' => "Esta acción eliminará el Sistema con el nombre ':name'. Los libros contenidos en él no se eliminarán.",
    ...
    'shelves_permissions_cascade_warning' => 'Los permisos en los Sistemas no se aplican automáticamente a los libros que contengan. Esto se debe a que un libro puede existir en múltiples Sistemas. Sin embargo, los permisos pueden ser aplicados a los libros del Sistema utilizando la opción de abajo.',
    ...
    'shelves_copy_permissions_explain' => 'Esta acción aplicará los permisos del Sistema a todos los libros dentro del mismo. Antes de activarlo, asegúrese de que todos los cambios de permisos para este Sistema fueron guardados.',
    ...
    'books_delete_explain' => 'Esto borrará el libro con el nombre \':bookName\', Todas las páginas y Releases serán removidos.',
    ...
    'books_sort_chapters_first' => 'Releases primero',
    ...
    'books_sort_move_next_chapter' => 'Mover al Release siguiente',
    ...
    'chapters_delete_explain' => 'Esta acción eliminará el Release con el nombre \':chapterName\'. Todas las páginas que existen dentro del Release también se eliminarán.',
    ...
    'chapters_permissions_active' => 'Permisos de Release activado',
    'chapters_permissions_success' => 'Permisos de Release actualizados',
    'chapters_search_this' => 'Buscar en este Release',
    ...
    'pages_not_in_chapter' => 'La página no esá en el Release',
    ...
    'tags_assigned_chapters' => 'Asignadas a Releases',
    ...
    'profile_not_created_chapters' => ':userName no ha creado Releases',
    ...
    'convert_to_book_desc' => 'Puede convertir este Release en un nuevo libro con el mismo contenido. Cualquier permiso establecido en este Release será copiado al nuevo libro pero cualquier permiso heredado, del libro padre, no se copiará lo que podría derivar en un cambio en el control de acceso.',
    'convert_chapter' => 'Convertir Release',
    'convert_chapter_confirm' => '¿Está seguro de que quiere convertir este Release?',
