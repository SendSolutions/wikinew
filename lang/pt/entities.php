...
return [
    ...
    'recently_created_chapters' => 'Releases Criados Recentemente',
    'recently_created_books' => 'Módulos Criados Recentemente',
    ...
    'permissions_book_cascade' => 'Permissões definidas em Módulos serão automaticamente convertidas para páginas e Releases filhos, a menos que tenham suas próprias permissões definidas.',
    'permissions_chapter_cascade' => 'Permissões definidas em Releases serão automaticamente convertidas em páginas filhas, a menos que tenham suas próprias permissões definidas.',
    'permissions_save' => 'Guardar Permissões',
    'permissions_owner' => 'Proprietário',
    'permissions_role_everyone_else' => 'RSistema',
    ...
    'shelves_create' => 'Criar Novo Sistema',
    'shelves_popular' => 'Sistemas Populares',
    'shelves_new' => 'Sistemas Novas',
    'shelves_new_action' => 'Novo Sistema',
    'shelves_popular_empty' => 'As Sistemas mais populares serão mostradas aqui.',
    'shelves_new_empty' => 'As mais recentes Sistemas criadas serão mostradas aqui.',
    'shelves_save' => 'Guardar Sistema',
    'shelves_books' => 'Módulos nesta Sistema',
    'shelves_add_books' => 'Adicionar Módulos a esta Sistema',
    'shelves_drag_books' => 'Arraste os Módulos abaixo para adicioná-los a esta prateleira',
    'shelves_empty_contents' => 'Esta Sistema não tem Módulos atribuídos',
    ...
    'shelves_delete_explain' => "A ação vai eliminar a Sistema ':name'. Os Módulos nela presentes não serão eliminados.",
    'shelves_delete_confirmation' => 'Tem a certeza que deseja eliminar esta Sistema?',
    'shelves_permissions' => 'Permissões da Sistema',
    'shelves_permissions_updated' => 'Permissões da Sistema Atualizada',
    'shelves_permissions_active' => 'Permissões da Sistema Ativas',
    'shelves_permissions_cascade_warning' => 'As permissões nas Sistemas não são passadas automaticamente em efeito dominó para os Módulos contidos. Isto acontece porque um Módulo pode existir em várias Sistemas. As permissões podem, no entanto, ser copiadas para Módulos filhos usando a opção abaixo.',
    'shelves_permissions_create' => 'As permissões de criação de prateleira são usadas apenas para copiar Módulos filhos usando a ação abaixo. Eles não controlam a capacidade de criar Módulos.',
    'shelves_copy_permissions_to_books' => 'Copiar Permissões para Módulos',
    'shelves_copy_permissions' => 'Copiar Permissões',
    'shelves_copy_permissions_explain' => 'Isto aplicará as configurações de permissões atuais desta Sistema a todos os Módulos nela contidos. Antes de ativar, assegure-se de que quaisquer alterações nas permissões desta Sistema foram guardadas.',
    'shelves_copy_permission_success' => 'Permissões da Sistema copiadas para :count Módulos',
    ...
    'books_popular_empty' => 'Os Módulos mais populares serão mostrados aqui.',
    'books_new_empty' => 'Os Módulos mais recentemente criados serão mostrados aqui.',
    'books_create' => 'Criar Módulo Novo',
    'books_delete' => 'Eliminar Módulo',
    'books_delete_named' => 'Eliminar Módulo :bookName',
    'books_delete_explain' => 'A ação vai eliminar o Módulo com de nome \':bookName\'. Todas as páginas e Releases serão também removidos.',
    'books_delete_confirmation' => 'Tem a certeza que quer eliminar este Módulo?',
    'books_edit' => 'Editar Módulo',
    'books_edit_named' => 'Editar Módulo :bookName',
    'books_form_book_name' => 'Nome do Módulo',
    'books_save' => 'Guardar Módulo',
    ...
    'books_sort_show_other_desc' => 'Adicione outros Módulos aqui para incluí-los na operação de classificação e permitir a reorganização fácil de todos os Módulos.',
    'books_sort_move_up' => 'Mover para Cima',
    'books_sort_move_down' => 'Mover para baixo',
    'books_sort_move_prev_book' => 'Mover para o Módulo Anterior',
    ...
    'chapters_delete' => 'Eliminar Release',
    'chapters_delete_named' => 'Eliminar Release :chapterName',
    'chapters_delete_explain' => 'Isto irá eliminar o Release com o nome \':chapterName\'. Todas as páginas existentes dentro do mesmo serão também eliminadas.',
    'chapters_delete_confirm' => 'Tem certeza que deseja eliminar o Release?',
    'chapters_edit' => 'Editar Release',
    'chapters_edit_named' => 'Editar Release :chapterName',
    'chapters_save' => 'Guardar Release',
    'chapters_move' => 'Mover Release',
    'chapters_move_named' => 'Mover Release :chapterName',
    'chapters_copy' => 'Copiar Release',
    'chapters_copy_success' => 'Release copiado com sucesso',
    'chapters_permissions' => 'Permissões do Release',
    'chapters_empty' => 'Nenhuma página existente neste Release.',
    ...
    'chapter_sort_book' => 'Ordenar Módulo',
    ...
    'pages_not_in_chapter' => 'A página não está dentro de um Release',
    ...
    'chapter_tags' => 'Etiquetas do Release',
    'book_tags' => 'Etiquetas do Módulo',
    ...
    'tags_list_empty_hint' => 'As tags podem ser atribuídas através da barra lateral do editor de página ou ao editar os detalhes de um Módulo, Release ou prateleira.',
    'attachments' => 'Anexos',
    ...
    'convert_to_shelf_contents_desc' => 'Você pode converter este Módulo em uma nova prateleira com o mesmo conteúdo. Releases contidos neste Módulo serão convertidos em novos Módulos. Se este Módulo contiver alguma página, que não estão em um Release, este Módulo será renomeado contendo essas páginas, e o mesmo se tornará parte da nova prateleira.',
    'convert_to_shelf_permissions_desc' => 'Quaisquer permissões definidas neste Módulo serão copiadas para a nova prateleira e para todos os novos Módulos filhos que não tenham as suas próprias permissões impostas. Observe que as permissões nas prateleiras não são do tipo cascata como o são para os Módulos.',
    'convert_book' => 'Converter Módulo',
    'convert_book_confirm' => 'Tem a certeza de que deseja converter este Módulo?',
    'convert_undo_warning' => 'Isto não pode ser tão facilmente desfeito.',
    'convert_to_book' => 'Converter para Módulo',
    'convert_to_book_desc' => 'Você pode converter este Release em um Novo Módulo com o mesmo conteúdo. Qualquer permissão definida neste Release será copiada para o Novo Módulo, mas para as permissões herdadas, do Módulo pai não será copiado que possa levar a uma mudança de controlo de acesso.',
    ...
    'watch_detail_parent_book_ignore' => 'A ignorar através do Módulo pai',
