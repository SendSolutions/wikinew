...
return [
    ...
    'maint_recycle_bin_desc' => 'Sistemas, Módulos, Releases e páginas eliminados são mandados para a reciclagem podendo assim ser restaurados ou excluídos permanentemente. Itens mais antigos da podem vir a ser automaticamente removidos da reciclagem após um tempo, dependendo da configuração do sistema.',
    ...
    'role_manage_entity_permissions' => 'Gerir todos os Módulos, Releases e permissões de páginas',
    'role_manage_own_entity_permissions' => 'Gerir permissões de seu próprio Módulo, Release e paginas',
    ...
    'role_asset_desc' => 'Estas permissões controlam o acesso padrão para os ativos dentro do sistema. Permissões em Módulos, Releases e Páginas serão sobrescritas por estas permissões.',
