...
return [
    ...
    'recently_created_chapters' => 'Releases recientemente creados',
    'recently_created_books' => 'Libros recientemente creados',
    'recently_created_shelves' => 'Sistemas recientemente creados',
    ...
    'import_desc' => 'Importar libros, Releases y páginas usando una exportación zip portable de la misma o distinta instancia. Seleccione un archivo ZIP para continuar. Después de que el archivo haya sido subido y validado, podrá configurar y confirmar la importación en la siguiente vista.',
    ...
    'permissions_book_cascade' => 'Los permisos establecidos en los libros se aplicarán a sus Releases y páginas, a menos que tengan sus propios permisos definidos.',
    'permissions_chapter_cascade' => 'Los permisos establecidos en los Releases se aplicarán a sus páginas, a menos que tengan sus propios permisos definidos.',
    ...
    'shelves_empty' => 'No hay Sistemas creados',
    'shelves_create' => 'Crear Sistema',
    'shelves_popular' => 'Sistemas populares',
    'shelves_new' => 'Sistemas nuevos',
    'shelves_new_action' => 'Nuevo Sistema',
    ...
    'shelves_books' => 'Libros en este Sistema',
    'shelves_add_books' => 'Añadir libros a este Sistema',
    'shelves_drag_books' => 'Arrastra los libros a continuación para añadirlos a este Sistema',
    'shelves_empty_contents' => 'Este Sistema no tiene libros asignados',
    'shelves_edit_and_assign' => 'Editar el Sistema para asignar libros',
    'shelves_edit_named' => 'Editar Sistema :name',
    'shelves_edit' => 'Editar Sistema',
    'shelves_delete' => 'Eliminar Sistema',
    'shelves_delete_named' => 'Eliminar Sistema :name',
    'shelves_delete_explain' => "Esto eliminará el Sistema con el nombre ':name'. Los libros que contenga no se eliminarán.",
    'shelves_delete_confirmation' => '¿Está seguro de que desea borrar este Sistema?',
    'shelves_permissions' => 'Permisos del Sistema',
    'shelves_permissions_updated' => 'Permisos del Sistema actualizados',
    'shelves_permissions_active' => 'Permisos del Sistema activos',
    'shelves_permissions_cascade_warning' => 'Los permisos en los Sistemas no se aplican automáticamente a los libros que contengan. Esto se debe a que un libro puede existir en múltiples Sistemas. Sin embargo, los permisos pueden ser aplicados a los libros del Sistema utilizando la opción a continuación.',
    'shelves_permissions_create' => 'Los permisos de creación de Sistemas sólo se utilizan para copiar los permisos a los libros contenidos utilizando la acción a continuación. No controlan la capacidad de crear libros.',
    'shelves_copy_permissions_to_books' => 'Copiar permisos a los libros',
    'shelves_copy_permissions' => 'Copiar permisos',
    'shelves_copy_permissions_explain' => 'Esto aplicará los permisos de este Sistema para todos sus libros. Antes de activarlo, asegúrese de que todos los cambios de permisos para este Sistema han sido guardados.',
    'shelves_copy_permission_success' => 'Permisos del Sistema copiados a :count libros',
    ...
    'books_delete_explain' => 'Esto borrará el libro con el nombre \':bookName\', Todos las páginas y Releases serán borrados.',
    ...
    'books_empty_contents' => 'Ninguna página o Release ha sido creada para este libro.',
    'books_empty_create_page' => 'Crear una nueva página',
    'books_empty_sort_current_book' => 'Organizar el libro actual',
    'books_empty_add_chapter' => 'Agregar un Release',
    ...
    'books_sort_desc' => 'Mueve Releases y páginas dentro de un libro para reorganizar su contenido. Se pueden añadir otros libros que permiten mover fácilmente Releases y páginas entre libros. Opcionalmente, se puede establecer una regla de ordenación automática para ordenar automáticamente el contenido de este libro cuando haya cambios.',
    ...
    'books_sort_chapters_first' => 'Releases al inicio',
    'books_sort_chapters_last' => 'Releases al final ',
    ...
    'books_sort_move_prev_chapter' => 'Mover al Release anterior',
    'books_sort_move_next_chapter' => 'Mover al siguiente Release',
    'books_sort_move_book_start' => 'Mover al inicio del libro',
    'books_sort_move_book_end' => 'Mover al final del libro',
    'books_sort_move_before_chapter' => 'Mover a antes del Release',
    'books_sort_move_after_chapter' => 'Mover a después del Release',
    ...
    'chapters_new' => 'Nuevo Release',
    'chapters_create' => 'Crear nuevo Release',
    'chapters_delete' => 'Borrar Release',
    'chapters_delete_named' => 'Borrar Release :chapterName',
    'chapters_delete_explain' => 'Esto eliminará el Release con el nombre \':chapterName\'. También se eliminarán todas las páginas que existen dentro de este Release.',
    'chapters_delete_confirm' => '¿Está seguro de borrar este Release?',
    ...
    'chapters_copy_success' => 'Release copiado correctamente',
    'chapters_permissions' => 'Permisos de Release',
    'chapters_empty' => 'No existen páginas en este Release.',
    'chapters_permissions_active' => 'Permisos de Release activos',
    'chapters_permissions_success' => 'Permisos de Release actualizados',
    'chapters_search_this' => 'Buscar este Release',
    ...
    'pages_delete_warning_template' => 'Esta página está en uso como plantilla de página predeterminada de libro o Release. Estos libros o Releases ya no tendrán una plantilla de página predeterminada asignada después de eliminar esta página.',
    ...
    'pages_not_in_chapter' => 'La página no está en un Release',
    ...
    'chapter_tags' => 'Etiquetas de Release',
    ...
    'tags_list_empty_hint' => 'Las etiquetas se pueden asignar a través de la barra lateral del editor de páginas o mientras se editan los detalles de un libro, Release o Sistema.',
    ...
    'profile_not_created_chapters' => ':userName no ha creado ningún Release',
    'profile_not_created_books' => ':userName no ha creado ningún libro',
    'profile_not_created_shelves' => ':userName no ha creado ningún Sistema',
    ...
    'convert_to_shelf_contents_desc' => 'Puedes convertir este libro a un nuevo Sistema con el mismo contenido. Los Releases contenidos en este libro se convertirán en libros nuevos. Si este libro contiene alguna página, que no esté en un Release, este libro será renombrado y contendrá tales páginas, y este libro pasará a formar parte del nuevo Sistema.',
    ...
    'convert_to_book_desc' => 'Puede convertir este Release en un nuevo libro con el mismo contenido. Cualquier permiso establecido en este Release será copiado al nuevo libro pero cualquier permiso heredado, del libro padre, no se copiará lo que podría conducir a un cambio de control de acceso.',
    'convert_chapter' => 'Convertir Release',
    'convert_chapter_confirm' => '¿Estás seguro de que quieres convertir este Release?',
    ...
    'watch_detail_parent_chapter' => 'Subscripciones por Release superior',
    'watch_detail_parent_chapter_ignore' => 'Ignorar por Release superior',
];
