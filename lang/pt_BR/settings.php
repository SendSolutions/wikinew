...
return [
    ...
    'bookshelf_color' => 'Cor da Sistema',
    'book_color' => 'Cor do Módulo',
    'chapter_color' => 'Cor do Release',
    ...
    'sorting_book_default' => 'Classificação padrão de Módulos',
    ...
    'maint_recycle_bin_desc' => 'Sistemas, Módulos, Releases e páginas excluídos são mandados para a lixeira podendo assim ser restaurados ou excluídos permanentemente. Itens mais antigos da lixeira podem vir a ser automaticamente removidos da lixeira após um tempo dependendo da configuração do sistema.',
    ...
    'role_manage_entity_permissions' => 'Gerenciar todos os Módulos, Releases e permissões de páginas',
    'role_manage_own_entity_permissions' => 'Gerenciar permissões de seu próprio Módulo, Release e paginas',
    ...
    'role_asset_desc' => 'Essas permissões controlam o acesso padrão para os ativos dentro do sistema. Permissões em Módulos, Releases e Páginas serão sobrescritas por essas permissões.',
